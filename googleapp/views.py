...
def route(request):
    ...
    return render(request, 'googleapp/route.html', context)


def map(request):
    """Basic vire for displaying a map"""
    ...
    if lat_a and lat_b and lat_c and lat_d:
        ...
        return redirect(reverse('googleapp:route'))
    ...
    return render(request, 'googleapp/map.html', context)
